...
// *** UPNP SERVICE WRAPPER ***
  ...
  UPnP.prototype.sendRequest = function( upnpServiceType, upnpActionName, upnpEndpointURL, upnpRequestXML, onUPnPResponse ) {
    ...
    try {
      ...
      console.log(upnpEndpointURL,'SOAPAction', '"' + upnpServiceType.replace(/[\"\#]/g, '') + '#' + upnpActionName.replace(/[\"\#]/g, '') + '"')
      ...
      xhr.onreadystatechange = function (e) {
        ...
        if( e.target.status !== 200 ) {
          ...
          onUPnPResponse.apply(undefined, [ new UPnPError('XmlHttpRequest expected 200 OK. Received ' + e.target.status + ' response.'), null ]);

          console.log( "[ERROR-RESPONSE] " + e.target.responseText );
        ...
        console.log( "[SUCCESS-RESPONSE] " + e.target.responseText );
      ...
      console.log("REQUESTTTTTTTTT " + upnpRequestXML)
...
var Plug = global.Plug;
  ...
  // *** RenderingControl:1 methods
    ...
    this.getMute = function( instanceId, channel, callback ) {
      console.log(instanceId, channel, callback)
