...
var INFO_URL = 'http://'+ip.address()+':8081/?link=http://www.youtube.com/get_video_info?el=detailpage&video_id=';
var KEYS_TO_SPLIT = [
  'keywords'
, 'fmt_list'
, 'fexp'
 ...
 */
 var urls = [];
ytdl.getInfo = function getInfo(link, video, requestOptions, callback) {
  ...
  request(requestOptions, function(err, res, body) {
    ...
    if (info.status === 'fail') {
		var error ={};
		error.id = video.id;
		error.details = 'Error ' + info.errorcode + ': ' + info.reason +' , link: '+video.link; 
