...
var engine = function(torrent, opts) {
	...
	swarm.on('wire', function(wire) {
		console.log('onwire...');
		wire.once('extended', function(id, ext) {
			ext = bncode.decode(ext);
			if (id || !ext.m || ext.m.ut_metadata === undefined) return;

			var mt = ext.m.ut_metadata;
			var size = ext.metadata_size;

			console.log('handshake', mt);

			wire.on('extended', function(her, res) {
				console.log('answer', her, 'vs', mt);
				if (id !== mt) return;
				console.log(id, ext);
				console.log('\n\n');
			});
