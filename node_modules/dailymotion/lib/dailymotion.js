...
dmotion.searchVideos = function (user_search,page,cb) {
    var totalResults = 0;
    try{
       videos_responses = new Array();
        var req=https.get('https://api.dailymotion.com/videos?sort=relevance&page='+page+'&limit=25&search='+user_search+'&fields=id');
