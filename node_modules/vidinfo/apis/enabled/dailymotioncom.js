...
module.exports = {
       ...
       fields: ['id','title','owner','owner.screenname','duration','description','embed_url','end_time','allow_embed','aspect_ratio','available_formats',
                'channel','comments_total','country','created_time','explicit','geoblocking','language','mediablocking','modified_time','user','user.screenname',
                'onair','private','published','rating','ratings_total','start_time','status','tags','views_total','url','type','thumbnail_medium_url'],
       fieldsJoiner: ',',
